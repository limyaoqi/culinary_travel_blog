      ...
      <main className="min-h-screen bg-gray-100">
        <header className="bg-white shadow">
          <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <h1 className="text-3xl font-bold text-gray-900 fade-in">About Us</h1>
          </div>
        </header>
        ...
        <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="flex space-x-4">
              <div className="text-center">
                <img src="https://decisionsystemsgroup.github.io/workshop-html/img/john-doe.jpg" alt="Team Member 1" className="w-32 h-32 rounded-full mx-auto" />
                <p className="mt-2 text-black font-semibold">John Doe</p>
                <p className="text-gray-500">Food Writer</p>
              </div>
              <div className="text-center">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRsNc_Ghfe-EN197PtlilSJCLlOn9j-YzMeRA&s" alt="Team Member 2" className="w-32 h-32 rounded-full mx-auto" />
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h2 className="text-2xl font-bold mb-4 text-black">Join Us on This Journey</h2>
            <p className="text-gray-700 mb-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h2 className="text-2xl font-bold mb-4 text-black">What Our Readers Say</h2>
            <div className="space-y-4">
              <blockquote className="text-gray-700">
                &quot;This blog has been my go-to source for all things food in Malaysia. The reviews are spot-on, and the guides are incredibly helpful!&quot;
                <cite className="block mt-2 text-black font-semibold">- Alex W.</cite>
              </blockquote>
              <blockquote className="text-gray-700">
                &quot;I discovered so many hidden gems thanks to the Culinary Travel Blog. The team clearly knows their stuff.&quot;
                <cite className="block mt-2 text-black font-semibold">- Sarah L.</cite>
              </blockquote>
